...
echo "vcf:$gvcf_file; dbsnp:$dbsnp_file; n_proc:$n_proc; norm_py:$norm_py; reference: $reference; cnvvcf_chk:$cnvvcf_chk $cnvvcf"
...
#cp $gvcf_name.norm.tsv $outfolder/$gvcf_name.norm.tsv
#cp $gvcf_name.tab.gz $outfolder/$gvcf_name.tab.gz
