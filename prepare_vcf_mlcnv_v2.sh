...
echo "vcf:$gvcf_file; dbsnp:$dbsnp_file; n_proc:$n_proc; norm_py:$norm_py; reference: $reference; cnvvcf_chk:$cnvvcf_chk $cnvvcf; ponvcf_chk:$ponvcf_chk $ponvcf; infovcf_chk:$infovcf"
